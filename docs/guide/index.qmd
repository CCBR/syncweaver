...
through the CCBR/syncweaver orchestrator. Host repos can become Code Ocean capsules.
...
## dependency analysis and release impact tracing

This view highlights how `functracer` narrows updates to only affected capsules
